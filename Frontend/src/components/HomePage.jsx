...
function HeroSection() {
  // parallax removed: keep hero background static on scroll
  ...
  return (
    <section className="h-screen min-h-[480px] sm:min-h-[600px] md:min-h-[700px] lg:min-h-[86vh] overflow-hidden bg-slate-950 text-white">
      ...
      >
        ...
        {/* HEADING */}
        <h1 className="text-left text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black leading-[1] tracking-tight text-white max-w-xl sm:max-w-2xl md:max-w-4xl">
          Find Your
        ...
        {/* DESCRIPTION */}
        <p className="text-left mt-5 sm:mt-6 max-w-xs sm:max-w-lg md:max-w-2xl text-sm sm:text-base md:text-lg lg:text-xl leading-8 text-slate-300">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-start gap-4">
          <Link to="/properties" className="rounded-xl bg-cyan-400 px-5 sm:px-6 py-3 text-sm sm:text-base font-semibold text-black shadow-[0_15px_40px_rgba(34,211,238,0.35)] transition-all duration-300 hover:scale-105 hover:bg-cyan-300">
            Browse Properties
          </Link>

          <Link to="/contact" className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-xl px-5 sm:px-6 py-3 text-sm sm:text-base font-semibold text-white transition-all duration-300 hover:bg-white/10">
            Free Valuation
          </Link>
        </div>
      </ResponsiveContainer>
